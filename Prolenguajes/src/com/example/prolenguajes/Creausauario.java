...
public class Creausauario extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_creausauario);
	}

	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		// Inflate the menu; this adds items to the action bar if it is present.
		getMenuInflater().inflate(R.menu.creausauario, menu);
		return true;
	}
	public void Login(View V){
		EditText txtlo=(EditText)findViewById(R.id.editText1);
		EditText txt2=(EditText)findViewById(R.id.editText2);
		new HttpAsyncTask().execute("https://murmuring-dawn-5532.herokuapp.com/get_usuario/"+txtlo.getText().toString()+"_"+txt2.getText().toString());
